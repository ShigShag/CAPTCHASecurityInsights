...
(function () {
    ...
    function Ue(e) {
        for (var r = 1; r < arguments.length; r++) {
            var t = arguments[r] != null ? arguments[r] : {}, i = Object.keys(t);
    ...
    function Ee(e, r) {
        ...
        function y(u) {
            ...
            for (; g && (g = 0, u[0] && (t = 0)), t;) {
                try {
                    if (i = 1, f && (s = u[0] & 2 ? f.return : u[0] ? f.throw || ((s = f.return) && s.call(f), 0) : f.next) && !(s = s.call(f, u[1])).done) {
                        return s;
                    }
                    switch (f = 0, s && (u = [
                            u[0] & 2,
    ...
    ;
    function xt(e) {
        return /^[0-9A-Za-z_-]{3,100}$/.test(e);
    }
    ;
    function Be(e) {
        return e === void 0 ? true : typeof e == 'string' && /^[a-z0-9_-]{0,32}$/i.test(e);
    }
    ;
    function je(e) {
        return e === void 0 ? true : typeof e == 'string' && /^[a-z0-9_\-=]{0,255}$/i.test(e);
    }
    function Ge(e) {
        return U([
            'normal',
    ...
    ;
    function Ye(e) {
        return e === 'auto' || /^[a-z]{2,3}([-_][a-z]{2})?$/i.test(e);
    }
    function Qe(e) {
        return U([
            'always',
    ...
    function fe(e, r, t) {
        return Ae() ? fe = Reflect.construct : fe = function (f, s, g) {
            var v = [null];
            v.push.apply(v, s);
            var y = Function.bind.apply(f, v), u = new y();
    ...
    function Re(e) {
        return e.startsWith('cf-chl-widget-') ? e.substring('cf-chl-widget-'.length) : null;
    }
    function X(e) {
        return ''.concat('cf-chl-widget-').concat(e);
    }
    function Je() {
        var r = document.currentScript;
        if (k(r, HTMLScriptElement) && /\/turnstile\/v0(\/.*)?\/api\.js/.test(r.src)) {
            return r;
        }
        debugger
        for (var t = document.querySelectorAll('script'), i = 0, f; f = t[i]; i++) {
            if (k(f, HTMLScriptElement) && /\/turnstile\/v0(\/.*)?\/api\.js/.test(f.src)) {
                return f;
            }
        }
        var scriptTag = document.createElement('script');
        scriptTag.type = 'application/javascript';
        scriptTag.dataset.placeholder = 'Turnstile';
    ...
    function or(e, r) {
        ...
        try {
            for (var s = e.widgetMap[Symbol.iterator](), g; !(t = (g = s.next()).done); t = true) {
                ...
                if ((u.isExecuting || !u.isInitialized || u.isInitialized && !u.isStale && !u.isExecuted) && u.watchcat.lastAckedSeq !== 0 && u.watchcat.lastAckedSeq < u.watchcat.seq - 1 - 3) {
                    var R;
                    u.watchcat.lastAckedSeq = 0;
                    u.watchcat.seq = 0;
                    u.isExecuting = false;
                    console.log('Turnstile Widget seem to have crashed: ', y);
                    ;
                    var d;
                    if ((R = e.msgHandler) === null || R === void 0 || R.call(e, {
                            data: {
                                ...
                                code: 300030,
                                event: 'fail',
                                rcV: (d = u.rcV) !== null && d !== void 0 ? d : '0/0'
                            }
                        }), r) {
                        var o;
                        window.postMessage({
                            ...
                            widgetId: y,
                            event: 'rcv-update',
                            rcV: (o = u.rcV) !== null && o !== void 0 ? o : '0/0'
                        }, '*');
                    }
                    continue;
                }
    ...
    function tt(e) {
        ...
        if (e.params._debugSitekeyOverrides && (e.params._debugSitekeyOverrides.offlabel !== 'default' && r.set('offlabel', e.params._debugSitekeyOverrides.offlabel), e.params._debugSitekeyOverrides.clearance_level !== 'default' && r.set('clearance_level', e.params._debugSitekeyOverrides.clearance_level)), r.size !== 0) {
            return r.toString();
        }
    }
    function rt(e, r) {
    ...
    function nt(e, r, t, i, f, s, g) {
        var v = rt(t, f), y = s ? 'h/'.concat(s, '/') : '', u = g ? '?'.concat(g) : '';
    ...
    function zt(e, r) {
        ...
        if (!(!i || !i.parentNode)) {
            ...
            e._pState = r;
            var s = new URL(i.src), g = document.createElement('script');
            ...
            g.src = s.toString();
            i == null || (t = i.parentNode) === null || t === void 0 || t.replaceChild(g, i);
            ;
        }
    }
    function Ht(e, r) {
    ...
    function Vt(e) {
        var r = function (t, i) {
            ...
            var g = at(t.tagName.toLowerCase()), v = ''.concat(g, '[').concat(f, ']');
    ...
    function qt(e, r, t) {
        for (var i = '', f = 0, s = document.createNodeIterator(e, NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_TEXT, {
                ...
                }), g; (g = s.nextNode()) !== null && i.length < t;) {
    ...
    function Bt(e) {
        if (typeof e != 'string') {
            throw new Error('djb2: expected string, got '.concat(typeof e == 'undefined' ? 'undefined' : L(e)));
        }
    ...
    function ut() {
        ...
        _.isRecaptchaCompatibilityMode && e.push('.g-recaptcha');
    ...
    function cr(e, r) {
        var t, i = rt(r.params, false), f = 'h/'.concat('g', '/'), s = document.getElementById(e);
        if (!s) {
        ...
        g.style.zIndex = '21474836419';
        ;
        var v = document.createElement('div');
        v.className = 'cf-turnstile-feedback';
        v.id = 'cf-fr-id';
        v.style.borderColor = '#000000';
        v.style.width = '450px';
        v.style.height = '450px';
        v.style.position = 'absolute';
        v.style.zIndex = '21474836420';
        v.style.borderWidth = '1px';
        v.style.borderColor = '#000';
        ...
        y.id = e + '-fr';
        y.setAttribute('src', ''.concat(i, '/cdn-cgi/challenge-platform/').concat(f, 'feedback-reports/').concat(Re(e)));
        y.setAttribute('allow', 'cross-origin-isolated; fullscreen');
        y.setAttribute('sandbox', 'allow-same-origin allow-scripts allow-popups allow-forms');
        ...
        b.setAttribute('ry', '12');
        b.setAttribute('rx', '12');
        b.setAttribute('cy', '12');
        b.setAttribute('cx', '12');
        b.setAttribute('fill', '#aaaaaa');
        b.setAttribute('stroke-width', '0');
        u.appendChild(b);
        ;
        ...
        v.appendChild(u);
        g.appendChild(v);
        (t = s.parentNode) === null || t === void 0 || t.appendChild(g);
        ;
    }
    function Qt(e, r) {
    ...
    function ot(e, r) {
        var t = r.params, i = t.size, f = i === void 0 ? 'normal' : i, s = r.mode;
        switch (s) {
    ...
    var st = (function () {
        ...
        function r() {
            return r = vt(function (d, o, n, c) {
                ...
                return Ee(this, function (I) {
                    switch (I.label) {
                    case 0:
                        if (a = d.params.sitekey, p = Xt(), !p) {
                            return x('Cannot determine Turnstile\'s embedded location, aborting clearance redemption.'), i(d, o, false), [2];
                        }
                    ...
                    case 2:
                        return C = I.sent(), C.status === 200 ? [
                            3,
                            3
                        ] : (x('Cannot determine Turnstile\'s embedded location, aborting clearance redemption.'), i(d, o, false), [
                            3,
                            5
                        ]);
                    case 3:
                    ...
                    case 4:
                        if (M = I.sent(), 'status' in M && M.status === 'redeemed') {
                            return i(d, o, true), [2];
                        }
                        I.label = 5;
                    case 5:
                    ...
                    case 6:
                        return q = I.sent(), x('Error contacting Turnstile, aborting clearance remdeption.'), i(d, o, false), [
                            3,
                            7
                        ];
                    case 7:
        ...
        function t(d, o, n) {
            if (d.params.retry === se.AUTO || n) {
                ...
                var c, a = n ? 0 : 2000 + ((c = d.params['retry-interval']) !== null && c !== void 0 ? c : 0);
        ...
        function f(d) {
            ...
            for (var o = d.attributes, n = o.length, c = new Array(n), a = 0; a < n; a++) {
                c[a] = o[a].name;
            }
            return c;
        }
                ...
                if (!(!n.widgetId || !_.widgetMap.has(n.widgetId))) {
                    ...
                    if (!(!c || !a)) {
                        ...
                        case 'init': {
                                ...
                                a.mode = n.mode;
                                a.mode === F.INVISIBLE && a.params['refresh-expired'] === j.MANUAL && x('refresh-expired=manual is impossible in invisible mode, consider using \''.concat(j.AUTO, '\' or \'').concat(j.NEVER, '\''));
                                a.params.appearance === V.ALWAYS || a.isExecuting && a.params.appearance === V.EXECUTE ? ot(h, a) : Gt(h);
                                h.style.display = '';
                                ;
                        ...
                        case 'complete': {
                                a.rcV = '0/0';
                                a.response = n.token;
                                n.sToken ? e(a, c, n.sToken, n.chlId) : i(a, c, false);
                                ;
                                break;
                            }
                        case 'fail': {
                                n.rcV && (a.rcV = n.rcV);
                                n.cfChlOut && (a.cfChlOut = n.cfChlOut);
                                n.cfChlOutS && (a.cfChlOutS = n.cfChlOutS);
                                n.code && (a.errorCode = n.code);
                                a.isExecuting = false;
                                a.isInitialized = true;
                                it(c);
                                ;
                                var M = a.cbError, q = n.code === 300030;
                                if (M) {
                                    var I;
                                    M(String((I = n.code) !== null && I !== void 0 ? I : 300020)) || (n.code && x('Error: '.concat(n.code)), t(a, c, q));
                                } else {
                                    n.code ? (t(a, c, q), m('Error: '.concat(n.code), 3076)) : t(a, c, false);
                                }
                                break;
                            }
                        case 'feedbackInit': {
                        ...
                        case 'tokenExpired': {
                                ...
                                var ve = a.cbExpired;
                                ve && ve(Ne);
                                a.params['refresh-expired'] === j.AUTO && !a.isResetting && b(c);
                                ;
                                break;
                            }
                        ...
                        case 'interactiveBegin': {
                                ...
                                te && te();
                                a.params.appearance === V.INTERACTION_ONLY && ot(ge, a);
                                ;
                                break;
                            }
                        case 'interactiveEnd': {
                        ...
                        case 'requestExtraParams': {
                                ...
                                (N = D.contentWindow) === null || N === void 0 || N.postMessage(Ue({
                                    ...
                                    wPr: {
                                        ...
                                        pi: {
                                            xp: Vt(D).substring(0, 500),
                                            pfp: qt(document, 3, 500),
        ...
        ;
        function g() {
            var o = 'abcdefghijklmnopqrstuvwxyz0123456789'.length, n;
            do {
                n = '';
                for (var c = 0; c < 5; c++) {
                    n += 'abcdefghijklmnopqrstuvwxyz0123456789'.charAt(Math.floor(Math.random() * o));
                }
        ...
        function u(d, o) {
            if (o) {
                ...
                o['after-interactive-callback'] && (d.cbAfterInteractive = o['after-interactive-callback']);
                o['before-interactive-callback'] && (d.cbBeforeInteractive = o['before-interactive-callback']);
                o.callback && (d.cbSuccess = o.callback);
                o['expired-callback'] && (d.cbExpired = o['expired-callback']);
                o['timeout-callback'] && (d.cbTimeout = o['timeout-callback']);
                o['error-callback'] && (d.cbError = o['error-callback']);
                o['unsupported-callback'] && (d.cbUnsupported = o['unsupported-callback']);
                o.chlPageData && (d.chlPageData = o.chlPageData);
                ;
            }
        }
        function b(d) {
            ...
            if (n) {
                ...
                n.watchcat.lastAckedSeq = 0;
                n.watchcat.seq = 0;
                if (n.params.execution === ne.RENDER) {
                    n.msgQueue.push(K.EXECUTE);
                    n.isExecuted = true;
                    n.isExecuting = true;
                }
                ;
                var c = X(o), a = document.querySelector('#'.concat(c));
                if (!c || !a) {
                ...
                var p;
                a.src = nt(o, n.params.sitekey, n.params, (p = n.rcV) !== null && p !== void 0 ? p : '0/0', false, 'g', tt(n));
                it(c);
                n.retryTimeout && window.clearTimeout(n.retryTimeout);
                ;
            } else {
        ...
        function T(d) {
            ...
            var c = X(n), a = [
                    'iframe#'.concat(c),
                    'input#'.concat(c, '_response'),
                    'input#'.concat(c, '_legacy_response'),
                    'input#'.concat(c, '_g_response')
                ];
        ...
        function S(d, o) {
            ...
            var h = fr(a);
            if (h) {
                var l = Object.assign(h, o), w = l.action, E = l.cData, O = l.chlPageData, C = l.sitekey, M;
                ...
                var Z;
                l['retry-interval'] = +((Z = l['retry-interval']) !== null && Z !== void 0 ? Z : 8000);
                var Q;
                l['expiry-interval'] = +((Q = l['expiry-interval']) !== null && Q !== void 0 ? Q : 290000);
                var ee;
                l.size = (ee = l.size) !== null && ee !== void 0 ? ee : H.NORMAL;
                var ce = l.callback, ue = l['expired-callback'], pe = l['timeout-callback'], Ne = l['after-interactive-callback'], ve = l['before-interactive-callback'], me = l['error-callback'], ge = l['unsupported-callback'];
                if (typeof C != 'string') {
                ...
                re != null && re.id.startsWith('cf-chl-widget-') && T(a);
                
                // I frame containing the widget
                ...
                var D = g(), B = X(D);
                if (!(!D || !B)) {
                    var le = [], ke = l.execution === ne.RENDER;
                    ke && le.push(K.EXECUTE);
                    _.lastWidgetIdx++;
                    ;
                    var Kt = +new Date(), Jt = {};
                    ...
                    // Url gets set here
                    N.setAttribute('src', nt(D, C, l, '02/0', false, 'g', tt(ft))); 

                    // /cdn-cgi/challenge-platform/h/g/orchestrate/chl_api/v1?ray=85fd6be7ce3ccb19
                    // /cdn-cgi/challenge-platform/h/g/orchestrate/chl_api/v1?ray=85fd6ea4bf3c1536

                    // Overwrite for debugging
                    // N.setAttribute('src', 'js/turnstile/normal_debugged.html');
                    debugger
                    ;
                    var dt = [
                    ...
                    U((Le = (c = document.featurePolicy) === null || c === void 0 || (n = c.features) === null || n === void 0 ? void 0 : n.call(c)) !== null && Le !== void 0 ? Le : [], 'private-token') && dt.push('private-token');
                    N.setAttribute('allow', dt.join('; '));
                    N.setAttribute('sandbox', 'allow-same-origin allow-scripts allow-popups');
                    N.id = B;
                    ;
                    var Pe;
                    N.tabIndex = (Pe = l.tabindex) !== null && Pe !== void 0 ? Pe : 0;
                    N.title = 'Widget containing a Cloudflare security challenge';
                    debugger
                    // Normal loaded
                    a.appendChild(N);
                    ;
                    var Me, Zt = (Me = l['response-field']) !== null && Me !== void 0 ? Me : true;
                    if (Zt) {
                        var ye = document.createElement('input');
                        ye.type = 'hidden';
                        var De;
                        if (ye.name = (De = l['response-field-name']) !== null && De !== void 0 ? De : 'cf-turnstile-response', ye.id = ''.concat(B, '_response'), a.appendChild(ye), typeof l['response-field-name'] != 'string' && sr(C)) {
                            var _e = document.createElement('input');
                            _e.type = 'hidden';
                            _e.name = 'cf_challenge_response';
                            _e.id = ''.concat(B, '_legacy_response');
                            a.appendChild(_e);
                            ;
                        }
                    }
                    if (_.isRecaptchaCompatibilityMode) {
                        ...
                        he.type = 'hidden';
                        he.name = 'g-recaptcha-response';
                        he.id = ''.concat(B, '_g_response');
                        a.appendChild(he);
                        ;
                    }
                    return B;
        ...
        function R() {
            var d, o = -1, n = true, c = false, a = void 0;
            try {
                for (var p = _.widgetMap[Symbol.iterator](), h; !(n = (h = p.next()).done); n = true) {
                    var l = be(h.value, 2), w = l[0], E = l[1];
                    if (o < E.idx) {
                        d = w;
                        o = E.idx;
                    }
        ...
        return {
            ...
            execute: function (o, n) {
                ...
                if (p) {
                    ...
                    if (p.response) {
                        p.isExecuting = false;
                        x('Call to execute() on a widget that was already executed ('.concat(h, '), execute() will return the previous token obtained. Consider using reset() before execute() to obtain a fresh token'));
                        p.cbSuccess && p.cbSuccess(p.response, false);
                        ;
                        return;
                    }
                    p.isExpired && x('Call to execute on a expired-widget ('.concat(h, '), consider using reset() before'));
                    p.isStale && (b(h), p.isExecuting = true);
                    p.msgQueue.push(K.EXECUTE);
                    p.isExecuted = true;
                    ;
                    var l = document.querySelector('#'.concat(h));
                    if (!l) {
                        p.isExecuting = false;
                        m('Widget '.concat(h, ' to execute was not found'), 43522);
                        ;
                        return;
                    }
                    if (p.isResetting) {
            ...
            isExpired: function (o) {
                ...
                if (typeof o == 'undefined') {
                    ...
                    if (c) {
                        var a, p;
                        return (p = (a = _.widgetMap.get(c)) === null || a === void 0 ? void 0 : a.isExpired) !== null && p !== void 0 ? p : false;
                    } else {
                        m('Could not find a widget', 43794);
                    }
                }
                var h = v(o);
                if (!h) {
                    return m('Could not find widget for provided container', 43778), false;
                }
                var l;
                return (l = (n = _.widgetMap.get(h)) === null || n === void 0 ? void 0 : n.isExpired) !== null && l !== void 0 ? l : false;
            }
        };
    }());
    function fr(e) {
        var r = e.getAttribute('data-sitekey'), t = { sitekey: r }, i = e.getAttribute('data-tabindex');
        ...
        if (s && (Ge(s) ? t.size = s : x('Unknown data-size value: "'.concat(s, '"'))), 0) {
            var g;
        }
    ...
    var de = false, A = Wt(), ct;
    _.scriptWasLoadedAsync = (ct = A == null ? void 0 : A.loadedAsync) !== null && ct !== void 0 ? ct : false;
    A != null && A.params && (ie = A.params.get('compat'), (ie == null ? void 0 : ie.toLowerCase()) === 'recaptcha' ? window.grecaptcha ? x('grecaptcha is already defined. The compatibility layer will not be enabled') : (x('Compatibility layer enabled'), _.isRecaptchaCompatibilityMode = true, window.grecaptcha = st) : ie !== null && x('Unknown value for api.js?compat: "'.concat(ie, '", ignoring')), A.params.forEach(function (e, r) {
        U([
            'onload',
            'compat',
            '_cb',
            '_reload',
            'render'
        ], r) || x('Unknown parameter passed to api.js: "?'.concat(r, '=...", ignoring'));
