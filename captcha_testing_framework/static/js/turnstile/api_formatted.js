...
(function() {
    ...
    function Je() {
        ...
        // Create a script element without setting `src` to avoid loading
        var scriptTag = document.createElement('script');
        scriptTag.type = 'application/javascript'; // Specify type to ensure it's recognized as a script
        scriptTag.dataset.placeholder = 'Turnstile'; // Use a custom data attribute to mark it
        document.body.appendChild(scriptTag);
        return scriptTag; // Return the newly created script tag
    }
    
    function Wt() {
        var e = Je(); // This will now always return a script element
        var r = {
            loadedAsync: !1,
